                        ...
                        <li className="shadow rounded-md bg-opacity-100 bg-white col-span-1 mt-5" key={reservationRequest._id}>
                            ...
                            <div>
                                <div className="px-4 sm:px-0">
                                    ...
                                    <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-500">Here is the information regarding your reservation request for this campsite</p>
                                </div>
                                <div className="mt-6 border-t border-gray-100">
                                    <dl className="divide-y divide-gray-100">
                                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                            <dt className="text-sm font-medium leading-6 text-gray-900">Name / Telephpne</dt>
                                        ...
                                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                            <dt className="text-sm font-medium leading-6 text-gray-900">Reservation Dates</dt>
                                        ...
                                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                            <dt className="text-sm font-medium leading-6 text-gray-900">Reservation Person Number</dt>
                                        ...
                                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                            <dt className="text-sm font-medium leading-6 text-gray-900">Caravan Accommodation</dt>
                                            <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">Yes</dd>
                                        </div>
                                        )}
                                        {reservationRequest?.bungalowRent && (
                                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                            <dt className="text-sm font-medium leading-6 text-gray-900">Bungalow Renting</dt>
                                            <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">Yes</dd>
                                        </div>
                                        )}
                                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                            <dt className="text-sm font-medium leading-6 text-gray-900">Note to host</dt>
                                            <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                                <p className="overflow-auto">{reservationRequest?.userMessage}</p>
                                            </dd>
                                        </div>
                                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                            <dt className="text-sm font-medium leading-6 text-gray-900">Note from host</dt>
                                            <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                        ...
                                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                            ...
                                            <dd className="mt-1 text-sm font-semibold text-red-700 leading-6  sm:col-span-2 sm:mt-0">Not approved by host yet</dd>
                                        </div>
                                        )}
                                        {reservationRequest?.approved && (
                                        <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                            <dt className="text-sm font-medium leading-6 text-gray-900">Status</dt>
                                            <dd className="mt-1 text-sm font-semibold text-green-700 leading-6  sm:col-span-2 sm:mt-0">Approved by host</dd>
                                        </div>
                                        )}
                                    </dl>
                                </div>
