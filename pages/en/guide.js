                    ...
                    <div className="w-full px-0 md:px-4 pt-16">
                        <div className="mx-0 w-full rounded-2xl bg-white p-2">
                            ...
                            {({ open }) => (
                                ...
                                <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                                Please note that CampUpp does not charge any fees. The payment will be made directly between the campground operators and you. If you see the message "You can make your payment by credit card at this establishment" on the campground's page, it means that the campground accepts credit card payments. Otherwise, the campground may only accept cash or other payment methods such as bank transfer. For more detailed information about payments, you should contact the campground operators where you plan to stay.
                                </Disclosure.Panel>
                                </>
                            )}
                            </Disclosure>
