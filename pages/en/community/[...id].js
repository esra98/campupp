...
export default function BlogPost() {
  ...
  return(
    <Layout>
                                  ...
                                  <div className="relative flex gap-x-3">
                                    ...
                                    <div className="text-sm leading-6">
                                      <label htmlFor="comments" className="font-medium text-gray-900">
                                        I you like to add your message to board as anonymous, check box aside.
                                      </label>
                                    </div> 
                                  </div>
                                </div>
                  ...
                  <ol className="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                      <div className="flex items-center">
                        ...
                        <Link href="/en/community" className="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-black">Community</Link>
                      </div>
                    </li>
                  </ol>
                  <div>
                    <button onClick={() => openReplyModal()}  className="p-2 gap-2 px-4 border flex rounded-xl  hover:bg-transparent shadow hover:shadow-md">
                        ...
                        <p className="font-semibold">Add Message to the Board</p>
                    </button>
                  </div>
                </nav>
                <div>
                        ...
                        <ol className="relative border-l border-gray-200"> 
                            ...
                            <li className="mb-10 ml-6" key={board.replies.created}>            
                                ...
                                <div className="items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:flex">
                                    ...
                                    <div>
                                        <div className="text-sm font-semibold text-gray-500 italic">{reply.anonymous ? "Anonymous" : reply.user}: </div>
        ...
        {!board && (
            <div>The board you are looking for
            not found, may have been removed</div>
        )}
        <Banner />
    </Layout>
)
