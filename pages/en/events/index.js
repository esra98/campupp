              ...
              <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow" key={event._id}>
                  <div className="flex flex-col p-5">
                      ...
                      <div className="min-w-0 flex-auto">
                          <p className="text-sm font-semibold leading-6 text-gray-900">Registration Name</p>
                          <p className="mt-1 truncate text-xs leading-5 text-gray-500">{event.reservationName}</p>
                      </div>
                      <div className="min-w-0 flex-auto">
                          <p className="text-sm font-semibold leading-6 text-gray-900">Provided Contact Phone Number</p>
                          <p className="mt-1 truncate text-xs leading-5 text-gray-500">{event.reservationTelephone}</p>
                      </div>
                      <div className="min-w-0 flex-auto">
                          <p className="text-sm font-semibold leading-6 text-gray-900">Provided Contact Email Address</p>
                          <p className="mt-1 truncate text-xs leading-5 text-gray-500">{event.reservationMail}</p>
                      </div>
                      <div className="min-w-0 flex-auto">
                          <p className="text-sm font-semibold leading-6 text-gray-900">Number of Participants for the Registration</p>
                          <p className="mt-1 truncate text-xs leading-5 text-gray-500">{event.peopleCount}</p>
                      </div>
                      <div className="flex mt-4 space-x-3 md:mt-6">
                          <Link onClick={()=>openModal(event._id)} className="inline-flex cursor-pointer items-center px-4 py-2 text-sm font-medium text-center text-white bg-rose-700 rounded-lg hover:bg-rose-800 focus:ring-4 focus:outline-none focus:ring-blue-300">Delete Registration</Link>
                          <Link href="#" className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200">View Event</Link>
                      </div>
                  </div>
              </div>
            ))}
