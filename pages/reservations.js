                    ...
                    <ul className="grid">
                        ...
                        <li className="shadow rounded-md bg-opacity-100 bg-white col-span-1 mt-5" key={reservationRequest._id}>
                            ...
                            <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50 rounded-md">
                                ...
                                <Link href={'/campsite/view/' + reservationRequest?.campsite} className="flex items-center justify-center gap-x-2.5 p-3 font-semibold text-gray-900 hover:bg-gray-100">
