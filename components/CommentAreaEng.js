...
const CommentArea = ({ owner,placeId }) => {
  ...
  async function saveComment(){
    if(commentDetail==""){
        toast.error('The title field cannot be left empty. Please provide a title for the request.')
        return
    }
    const data = {
                      ...
                      >
                        ...
                        <div className="relative p-6 flex-auto">
                          <div >
                                  ...
                                  <div className="relative flex gap-x-3">
                                    ...
                                    <div className="text-sm leading-6">
                                      <label htmlFor="comments" className="font-medium text-gray-900">
                                        If you want to add your comment anonymously, please select the checkbox next to it.
                                      </label>
                                    </div> 
                                  </div>
                                </div>
                            ...
                            <div>
                              <label htmlFor="email" className="block text-sm font-medium leading-6 text-gray-900 mt-3">
                              How would you rate the campsite on a scale of 1 to 5?
                              </label>
                              <div className="mt-2">
                                <input
                                ...
                                <div>
                                  ...
                                  <div className="mb-2 flex gap-2">
                                        ...
                                        {!editedCommentImages?.length &&(
                                            <div>no image added for the comment yet</div>
                                        )}
                                    </div>
                                  </div>
                                </div>   
    ...
    <div className="">
      <div className="block md:flex justify-between">
        ...
        <div>
          ...
          No comment has been added yet for this campsite.
          </div>
        </div>
        )}
        {comments?.length>0 && (
        <div>
          <div className="mb-5 mt-5">
            ...
            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">{comments?.length} comment(s)</p>
          </div>
        </div>
        )}
        <div>
          <button onClick={() => openModal()}  className="p-2 gap-2 px-4 border flex rounded-xl  hover:bg-transparent shadow hover:shadow-md">
            ...
            <p className="font-semibold">Add comment to this campsite</p>
          </button>
        </div>
      </div>
      <ul>
          ...
          <li key={comment._id} className="px-5 w-full py-3 shadow rounded-md mt-3 px-18">
            <div className="flex gap-x-4 px-8 py-4">
              <div className="min-w-0">
                ...
                {comment?.edited && (
                  <p><time dateTime={comment?.createdAt} className='text-xs text-gray-500'><span className='italic'>Edited:</span> {comment?.updatedAt.substring(0, 10)}</time></p>
                )}
                <div className="mt-3">
                <div>
                {comment?.point==5 && (
