                                    ...
                                    <div className="relative flex gap-x-3">
                                      ...
                                      <div className="text-sm leading-6">
                                        <label htmlFor="comments" className="font-medium text-gray-900">
                                          Sorunuzu anonim olarak eklemek istiyorsanız yandaki kutucuğu seçiniz.
                                        </label>
                                      </div> 
                                    </div>
                                  </div>
            ...
            <div className="flex justify-start md:justify-end">
              ...
              <div>
                <div className="gap-2 px-4 py-2 flex rounded-xl hover:bg-transparent">
                  Bu kamp yerine henüz soru sorulmamış
                </div>
              </div>
              )}
              <div>
                <button onClick={() => openQuestionModal()}  className="p-2 gap-2 px-4 border flex rounded-xl  hover:bg-transparent shadow hover:shadow-md">
                  ...
                  <p className="font-semibold">Kamp Yerine Soru Sorun</p>
                </button>
              </div>
            </div>
            <ul>
                ...
                <div className="flex gap-x-4 px-8 py-4">
                  <div className="min-w-0">
                    ...
                    {question?.replyText && (
                      <>
                      <div>
                        <h3 className='font-xs underline'>Kamp yerinin cevabı</h3>
                      </div>
