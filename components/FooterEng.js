...
export default function Footer(){
    return (
        <footer className="bg-cc-primary">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
                  <Link href="/" className="flex items-center">
                      <img src="https://campupp.s3.eu-north-1.amazonaws.com/LOGO.png" className="h-16 rounded-md mr-3" alt="FlowBite Logo" />
                  </Link>
              </div>
              <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                  <div>
                      <h2 className="mb-6 text-sm font-semibold text-white uppercase dark:text-white">Kaynaklar</h2>
                      <ul className="text-white dark:text-white font-medium">
                          <li className="mb-4">
                              <Link href="https://flowbite.com/" className="hover:underline">Blog</Link>
                          </li>
                          <li>
                              <Link href="https://tailwindcss.com/" className="hover:underline">Kullanım Rehberi</Link>
                          </li>
                      </ul>
                  </div>
                  <div>
                  ...
                  <div>
                      <h2 className="mb-6 text-sm font-semibold text-white uppercase dark:text-white">iletişim</h2>
                      <ul className="text-white dark:text-white font-medium">
                          <li className="mb-4">
                              <Link href="#" className="hover:underline">İletişim sayfası</Link>
                          </li>
                      </ul>
                  </div>
              </div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-sm text-white sm:text-center dark:text-white">© 2023 <a href="https://flowbite.com/" className="hover:underline">CampUpp</a>. Tüm hakları saklıdır.
              </span>
              <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                  <Link href="#" className="text-white hover:text-white dark:hover:text-white">
