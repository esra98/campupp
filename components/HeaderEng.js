...
const profile = [
  { name: 'My Favorites', description: 'List of your favorite campsites', href: '/en/favorites', icon: StarIcon },
  { name: 'My Reservation Requests', description: 'List of your reservation requests', href: '/en/reservations', icon: SquaresPlusIcon },
  { name: 'My Events', description: 'Events you have favorited and registered for', href: '/en/events', icon: UsersIcon },
]
const callsToAction = [
    ...
    <header className="bg-white shadow">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <Link href="/en" className="-m-1.5 p-1.5 outline-none">
